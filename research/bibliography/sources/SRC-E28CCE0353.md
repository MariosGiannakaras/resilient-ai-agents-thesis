...
GitHub - google-deepmind/open_spiel: OpenSpiel is a collection of environments and algorithms for research in general reinforcement learning and search/planning in games. · GitHub
Skip to content
Navigation Menu
Toggle navigation 
Sign in
...
google-deepmind / open_spiel Public
...
Installing OpenSpiel (for Linux and MacOS; see separate Windows Installation instructions.)
...
Report repository
Releases 30 (30)
OpenSpiel 2.0.1 Latest 2 weeks ago
+ 29 releases
Contributors 226 (226)
+ 212 contributors
Languages
C++ 57%
Python 38%

> Source: https://proceedings.mlr.press/v97/tessler19a/tessler19a.pdf
...
For the NR-MDP this selection process is somewhat harder; as slight changes in the hyper-parameters may result in radical changes in the performance. We selected the OU noise combined with α = 0.1 and a training ratio of 1:1. 
...
NR-MDP criterion; this does not hold on all domains. More-over, in most of the domains, both operators outperform the baseline, both in terms of robustness and in terms of performance in the absence of perturbations. While the optimal parameters may differ across domains; our results show that, in most cases, the parameters transfer across domains and result in improved performance without additional tuning. 

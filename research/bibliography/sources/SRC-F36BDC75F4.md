> Source: https://www.cs.ox.ac.uk/david.parker/papers/jpk-robust.pdf
...
U1 = {x0a1 ∈ [0.1, 0.9] ∧ x0b1 ∈ [0.1, 0.9] ∧ x2a0 ∈ [0.1, 0.9]} , U2 = {x0a1 ∈ [0.1, 0.4] ∧ x0b1 = 2x0a1 ∧ x2a0 ∈ [0.1, 0.9]} , (2) U3 = {x0a1 ∈ [0.1, 0.4] ∧ x0b1 = 2x0a1 ∧ x2a0 = x0a1} .
...
U(s,a). Similarly, an uncertainty set U is s-rectangular if U can be split into lower dimensional uncertainty sets U(s) 
...
depicted in Figure 3. Note that this IMDP is precisely the RMDP from Figure 1 with uncertainty set U1, see Example 1. 
...
1: Sort S′ = {s′1, . . . , s′m} according to V (n) ascending such that V (n)(s′i) ≤ V (n)(s′i+1) 2: ∀s′i ∈ S′: P (s, a, s′i)← 0 3: budget = 1− 
∑ s′∈S′ P̌ (s, a, s′) 
...
1: Sort S′ = {s′1, . . . , s′m} according to V (n) ascending such that V (n)(s′i) ≤ V (n)(s′i+1) 2: P (s, a, s′1)← min{1, P̃ (s, a, s′1) + d(s,a)/2} 3: ∀s′i ̸= s′1 ∈ S′: P (s, a, s′i)← P̃ (s, a, s′i) 4: i← m 5: while 
∑m j=1 P (s, a, s′j) > 1 do 
6: P (s, a, s′i)← max{0, 1− ∑ 

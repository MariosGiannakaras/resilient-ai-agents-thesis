...
COLORS = {
    "background": "#F5F7FA", "surface": "#FFFFFF", "surface_subtle": "#F9FAFB",
    "sidebar": "#111827", "sidebar_muted": "#9CA3AF", "text": "#172033",
    "muted": "#667085", "border": "#E4E7EC", "accent": "#2563EB",
    "accent_hover": "#1D4ED8", "accent_soft": "#EFF6FF", "locked": "#9A6700",
    "locked_bg": "#FFFAEB", "locked_border": "#FEDF89", "success": "#067647",
    "success_bg": "#ECFDF3", "danger": "#B42318", "danger_bg": "#FEF3F2",
}
...
def application_stylesheet() -> str:
    ...
    * {{ font-family: "Segoe UI", "Inter", sans-serif; font-size: 13px; color: {COLORS['text']}; }}
    ...
    QPushButton#NavButton {{ border: 0; border-radius: 7px; padding: 10px 12px; text-align: left; color: #D1D5DB; background: transparent; font-weight: 500; }}
    ...
    QFrame#Surface {{ background: {COLORS['surface']}; border: 1px solid {COLORS['border']}; border-radius: 10px; }}
    ...
    QLabel#StatusFrozen {{ color: #175CD3; background: {COLORS['accent_soft']}; border: 1px solid #B2DDFF; border-radius: 9px; padding: 3px 8px; font-size: 11px; font-weight: 700; }}
    ...
    QPushButton#SecondaryButton {{ background: {COLORS['surface']}; color: {COLORS['text']}; border: 1px solid #D0D5DD; border-radius: 7px; padding: 9px 14px; font-weight: 600; }}
    QPushButton#SecondaryButton:hover {{ background: #F9FAFB; }}
    QPushButton#LockedButton {{ background: #F2F4F7; color: #98A2B3; border: 1px solid #EAECF0; border-radius: 7px; padding: 9px 14px; font-weight: 600; }}
    ...
    QToolTip {{ background: #101828; color: #FFFFFF; border: 0; padding: 6px; }}
    """

...
The final sizing validator generated the complete combined five-method sizing package (`protocol-v2-t527-sizing-combined-v0.3`), integrating the structurally unaffected complete Q-Learning and SARSA strata from sizing-v0.2 with the complete DQN, PPO, and Dyna-Q+ strata from sizing-v0.3.
...
4. **PPO Parameter:** `n_steps` remains exactly 128.
5. **Phase-B Horizon:** The 256-interaction horizon is mechanically selected, as every method/root/layout pair in the combined matrix successfully completed at least two Adaptive native update opportunities and two branch episodes at horizon 256.
...
9. **Final Root Count:** The mechanically selected root count is 12, derived from the smallest candidate count achieving a Student-t 95% interval half-width below 0.20 for both Phase-A AUC and Phase-B adaptation benefit. The maximum half-width at 12 roots was 0.1428.
...
11. **Final Roots/Seeds:** Exactly 12 final roots (`t527-final-r01` through `t527-final-r12`) have been generated using the DEC-056 seed-stream formula (seeds 71001-76012) and are frozen in the final configuration.
...
- T-527 is COMPLETE.
- Issue #95 is 10/10 and CLOSED.
- T-528 is READY but has not started.
- Final-reserve scientific execution remains unauthorized pending an explicit later T-610+ authority.

...
Με βέλτιστη διαδρομή 12 ενεργειών, το −0,100 είναι η απόδοση μιας shortest-path επίλυσης του task: 11×(−0,1)+1,0=−0,1, αφού το goal reward +1,0 αντικαθιστά το final step reward.

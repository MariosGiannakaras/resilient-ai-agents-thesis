...
- **Package:** protocol-v2.0 methodology/scientific freeze remains immutable through DEC-058; the framework-neutral Study backend is complete through DEC-051/T-529; historical PySide6 application work remains complete through DEC-059/T-528; DEC-060/T-533, pre-final readiness hardening, the DEC-061 protocol-v2.1 experiment-first PySide6 rebuild `T-534`, and bounded intended-user hardening `T-535` are complete. `T-536` is the active final bounded visual-polish/richer-result-visualization package. DEC-042/047 and candidate v1.1 remain auditable predecessor design; historical NiceGUI remains prototype history only.
- **Project:** **7/8** master milestones objectively complete (#87: 1, 2, 3, 4, 5, 6, 7). Milestone 8 awaits the final v2.1 evidence chain.
- **Current task:** `T-536` is **IN_PROGRESS** on issue #112 / PR #113 from verified post-T-535 `main`. It is UI/UX/presentation work only and preserves T-534/T-535 as COMPLETE history.
- **Separate scientific gate:** `T-610` remains **BLOCKED**. T-536 must complete first, and a separate explicit final-scientific-experiment authorization remains mandatory afterward. UI CI, screenshots, DEVELOPMENT/synthetic fixtures, or T-536 completion do not authorize final execution.
...
- **Historical completed application baseline:** `T-528` remains COMPLETE and is not repurposed. It records the accepted PySide6 architecture/workflow/read-model/application baseline and prior intended-user acceptance history. Its presentation implementation is not the authority for the completed T-534/T-535 application; reusable UI-neutral contracts were preserved where still correct.
- **Pre-final readiness:** COMPLETE scientifically. Read-only preflight, backend deny-by-default final execution guard, synthetic DEVELOPMENT scientific-pipeline smoke, `docs/research/RQ_EVIDENCE_TRACEABILITY.md`, T-534, and T-535 are complete; the final reserve remains sealed. T-536 is final presentation polish, not a scientific amendment.
- **Repository integration:** PR #92 is historical and was squash-merged into `main` as `feb8c70395d13f506dad2ab60f4a71d4405f6298`. Subsequent protocol-v2.1 readiness and pre-UI context cleanup were also merged. PR #107 was squash-merged into `main` as `c372c581b88c63f3b07c96bd50bbc17b9b83f835` and is the completed T-534 implementation record. PR #110 was squash-merged into `main` as `225df138c5c5be0c39c9e474ef7fdbce6b11245b` and is the completed T-535 hardening record. PR #113 is the active T-536 visual-polish PR.
- **Trackers:** #87 master 7/8; #95 protocol-v2 10/10 CLOSED; #98 T-533 CLOSED/COMPLETE; #88 closed/superseded; #89 complete/closed; #93 T-528 complete/closed; #94 DEFERRED post-thesis; #104 T-534 COMPLETE/CLOSED; #109 T-535 COMPLETE/CLOSED; #112 T-536 IN_PROGRESS.
...
- **Exact next action:** complete T-536 through focused Qt tests, exact-head repository/UI CI, deterministic 1366×768/1440×900 visual review, canonical reconciliation, squash merge and merged-main verification. Then stop at the separate `T-610` scientific authorization gate. Do not access the final reserve, execute the final protocol-v2.1 matrix, inspect final outcomes, or begin WP7/Results/Discussion without the required separate approvals.
...
- [ ] IN_PROGRESS `T-536` — **Final visual polish and richer in-app result visualization** (#112 / PR #113).
  - Depends on: `T-535` — satisfied.
  - Preserve the accepted **Experiment / Run / Results / Evidence** information architecture, sidebar/navigation, immutable five-method Thesis experiment, and simultaneous exact Frozen/Adaptive Phase-B presentation; no Frozen/Adaptive selector.
  - Enlarge Run GridWorld presentation while preserving clean 1366×768 and 1440×900 layouts; make the current live method explicit as `Method N of 5 · Name` and retain a compact five-method durable lifecycle strip that is not a ranking.
  - Strengthen RQ1/RQ2 chart visual weight relative to supporting tables and add a true RQ3 stored-evidence trajectory visualization with baseline gap, frozen tolerance/window contract, stored recovery-time summary where available, and explicit right-censoring where recovery is unavailable.
  - The RQ3 visual may scale/position already-stored values only; it must not reduce roots, derive thresholds, classify recovery, substitute the horizon as recovery time, or recalculate any scientific estimand/interval.
  - Improve readability and page/section/card/secondary hierarchy through restrained spacing, typography and contrast; use existing DEVELOPMENT/Evidence content more effectively instead of adding decorative panels.
  ...
  - Explicit boundary: no final roots/layouts/seeds/outcomes, no final-reserve access, no T-610 activation, and no protocol/RQ/evidence/backend contract change.
  - Acceptance: focused T-536 Qt tests, exact-head Repository checks and PySide6 render CI, visual review at 1366×768 and 1440×900 with no clipping/overlap/excessive scrolling, canonical reconciliation, squash merge, merged-main verification and #112 closure.
...
- [ ] BLOCKED `T-610` — Execute frozen protocol-v2.1 final matrix through the accepted study-first execution path.
  - Depends on: `T-527`, `T-529`, `T-511`, `T-533`, `T-535`, `T-536` — scientific dependencies satisfied; T-536 currently IN_PROGRESS.
  - State: final-reserve access remains sealed. After T-536 completes, a separate explicit scientific execution authorization is still mandatory before any final-reserve access or execution. T-534/T-535/T-536 completion does not substitute for this gate.

...
- **Current task:** `T-611` is **COMPLETE**. The DEC-062 replacement Study `protocol-v2.1-final--t610-recovery-01` passed the full final-evidence integrity/completeness/provenance/lineage contract and is frozen under manifest SHA-256 `20a88bf9eee2ba8c4f60064634004f3746a594460f91fcd2491beae5cb498858`. The first 216-job attempt remains immutable failed/incomplete history and is explicitly excluded.

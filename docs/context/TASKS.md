...
- **Current task:** `T-611` is **COMPLETE**. The DEC-062 replacement Study `protocol-v2.1-final--t610-recovery-01` passed the full final-evidence integrity/completeness/provenance/lineage contract and is frozen under manifest SHA-256 `2d3f9e47b998b7e76b5a9fa984427d87e4bc5f038e4adbabbef9635e419cd2db`. The first 216-job attempt remains immutable failed/incomplete history and is explicitly excluded.
...
- **Final evidence:** VALIDATED/FROZEN by T-611. The replacement retains recipe SHA-256 `8f21075ad2bc7a7944dbac4ba2ee2f3255ec0157706b94f99174b6d9ef99b154` and plan SHA-256 `073779d18f45caeab2ab725e7dce6b54b70394102d45de81e1974c7efaece0f4`; all 600 scientific run bundles, 3,255 registered artifacts, finalized Study integrity map, exact Phase-A/checkpoint/Phase-B lineage, temporal schema-v2 records and run-index entries validate. The frozen 600-record run inventory SHA-256 is `0c2b352b88045951d32e58ee3479656dce00e35d55899bcdea65dc07604d8045`. No outcomes were interpreted.
...
- **Exact next action:** STOP at the completed T-611 boundary. `T-612` is the next dependency-valid task but must not start in this execution. Preserve the frozen package and both Study histories; do not interpret outcomes or begin T-612/T-613/WP7.
...
- [x] `T-611` — Validate/freeze v2.1 final evidence.
  ...
  - Frozen `results/final-evidence/protocol-v2.1-final/` atomically with validator commit `db6f1de53fcb0a7e9b4509950a5032b229befb8f`, manifest SHA-256 `2d3f9e47b998b7e76b5a9fa984427d87e4bc5f038e4adbabbef9635e419cd2db` and 600-record run-manifest inventory SHA-256 `0c2b352b88045951d32e58ee3479656dce00e35d55899bcdea65dc07604d8045`.
...
- [ ] READY `T-612` — Predeclared v2.1 nominal-learning/resilience/recovery statistical analysis and sensitivity diagnostics.
  - Depends on: `T-611`.

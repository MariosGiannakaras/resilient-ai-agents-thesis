...
- [ ] IN_PROGRESS `T-527` — Fair tuning, precision/runtime sizing, statistical freeze and machine-readable protocol-v2 firewall.
  ...
  - One reviewed physical attempt remains pending. It must execute fresh DQN/PPO/Dyna-Q+ from unit one (144 Phase-A units, 288 matched sets, 1,152 branches, 2,304 branch-horizon evaluations), then may build a reference-only combined 240/480/1,920/3,840 matrix. #95 remains 7/10. DEC-058/final reserve/final freeze/T-528 remain blocked until that matrix validates.

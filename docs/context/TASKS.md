...
- **Current task:** `T-610` is **BLOCKED fail-closed**. The user supplied the required separate explicit final-scientific-experiment authorization on 2026-09-02, but the authorized Study stopped after 216/603 completed jobs at a deterministic SARSA checkpoint-boundary infrastructure defect. The authorization does not extend to a recovery amendment, source-mixed continuation, T-611/T-612/T-613 or WP7.
...
- **Exact next action:** preserve the existing partial Study, 216 completed run bundles, run-index mutation and exact failure record unchanged. Do not retry, patch, finalize or interpret it. Require an explicit formal scientific recovery/amendment decision that defines evidence disposition and a reproducible single-source continuation or restart path before any further T-610 execution; T-611/T-612/T-613 and WP7 remain blocked.

...
4. Verify `protocol-v2.1-final--t610-recovery-01` remains the finalized 603/603 replacement from clean source commit `86fb01a13fd77b98ea0b8d8fa6d5c5d6e2cbd730` before any T-611 work.
...
Preserve scientific failures as outcomes. DEC-062 recovery and T-610 execution are complete. T-611 is next and may validate/freeze only the replacement evidence; the predecessor is permanently ineligible. Never replace roots/seeds, alter protocol choices, delete failed evidence, or mix execution instances.
...
T-610 is complete and this execution stopped at its boundary. Preserve the original failed attempt and finalized replacement. T-611 is the next dependency-valid task; T-612/T-613 remain blocked by dependencies and WP7 remains separately approval-gated.

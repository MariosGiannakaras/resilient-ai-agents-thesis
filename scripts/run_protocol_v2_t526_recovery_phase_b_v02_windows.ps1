...
$PullRequest = 92
$Amendment = 'configs/protocols/protocol-v2-t526-recovery-phase-b-v0.2.json'
...
if ($Pr.state -ne 'OPEN' -or -not $Pr.isDraft) {
    throw 'PR #92 must remain open and draft for DEC-053 T-526A.'
}
...
Write-Host ''
Write-Host 'DEC-053 T-526A / T-526 physical gate completed. Retained outputs:'
